...
import { FiScissors, FiClipboard, FiSettings, FiMenu, FiUsers, FiClock } from "react-icons/fi";
...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: "Clientes", icon: FiUsers, route: "/customers" },
  { name: "Horários", icon: FiClock, route: "/hours" },
